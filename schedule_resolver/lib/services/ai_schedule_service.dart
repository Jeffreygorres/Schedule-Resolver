...
class AiScheduleService extends ChangeNotifier {
  ...
  try {
    ...
    you are an expert student scheduling assistant. The usesr has provided the following tasks for their day in JSON format: $tasksJson
    ...
    Please provide exacly 4 sections of markdown text;
    
    1. ### Detected Conflicts
    List any Scheduling conflicts
    2. Ranked Tasks 
    Rank which tasks need attention first bassed on the urgency, importance and energy. Provide a brief reason on each> 
